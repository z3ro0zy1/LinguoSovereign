...
![LinguoSovereign 首页预览](./docs/screenshots/home-hero.png)
...
首页强调的是“连续学习工作流”，不是传统题库门户。入口、主路径和模块切换被压缩在同一屏里。

![首页 Hero](./docs/screenshots/home-hero.png)

### 模块页 / 题组目录

模块页保留了适合练习软件的目录式结构：按 Test 分组，行内直接进入作答、历史记录和详解。

![模块页与题组列表](./docs/screenshots/module-groups.png)

### 写作评分

写作部分支持 `Task 1 + Task 2` 组合提交，右侧直接展示总分、维度分和 AI 反馈。

![写作评分结果](./docs/screenshots/writing-eval.png)

### 口语转录评分

口语训练提供逐题转录、统一提交的模式，适合按 Part 逐步完成再统一评分。

![口语转录评分](./docs/screenshots/speaking-transcript.png)

### Review / AI 深度分析

Review 页支持查看历史作答，并展示 AI 生成的分析内容，用于复盘表达、语法和结构问题。

![AI 深度分析](./docs/screenshots/review-ai-analysis.png)
